...
oc create secret docker-registry aqua-registry --docker-server=registry.aquasec.com --docker-username=collin.spears@aquasec.com --docker-password=<pass_here> --docker-email=collin.spears@aquasec.com> -n aqua
...
# Deploy Aqua Enforcer (Windows Paths for Local OpenShift)
